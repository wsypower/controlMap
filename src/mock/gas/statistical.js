...
Mock.mock(/\/@test\/getGasMacStatusAnalysisData/, 'get', getStatusAnalysisData)

const getGasTrendData = options => {
  console.log('getGasTrendData options', options)
  const queryParameters = getQueryParameters(options)
  console.log('getGasTrendData query', queryParameters)
  let data1 = [
    {
...
Mock.mock(/\/@test\/getGasTrendData/, 'get', getGasTrendData)
