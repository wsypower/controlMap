...
Mock.mock(/\/@test\/getLightMacStatusAnalysisData/, 'get', getStatusAnalysisData)

const getPowerConsumptionTrendData = options => {
  console.log('getPowerConsumptionTrendData options', options)
  const queryParameters = getQueryParameters(options)
  console.log('getPowerConsumptionTrendData query', queryParameters)
  let data1 = [
    {
...
Mock.mock(/\/@test\/getPowerCoTrendData/, 'get', getPowerConsumptionTrendData)
