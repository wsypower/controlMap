...
const getEventDataList = (options) => {
    console.log(options)
    ...
    return builder(
        {
            code: 0,
            data: [{'id':0,'mapId':'','typeId':0,'name':'消防安全','levelId': '01','levelName':'一般','statusId':1,'statusName':'未开始','description':'xxx路与yyyy路交叉口烧烤店起火。','startDay': 1254523654125,'endDay':1254523654125, 'position':'xxx路与yyyy路交叉口','areaId':2,'areaName':'圆形','image':image,'fileList':fileList},
                {'id':1,'mapId':'','typeId':1,'name':'地震灾害','levelId': '02','levelName':'重大','statusId':2,'statusName':'进行中','description':'xxx县有1.4级地震，震源在深3500公里的地方。','startDay': 1254523654125,'endDay':1254523654125,'position':'xxxx县','areaId':2,'areaName':'圆形','image':image,'fileList':fileList},
                {'id':2,'mapId':'','typeId':3,'name':'洪涝灾害','levelId': '02','levelName':'重大','statusId':3,'statusName':'已完成','description':'烧烤店起火烧烤店起火烧烤店起火烧烤店起火烧烤店起火烧烤店起火烧烤店起火烧烤店起火烤店起火烧烤店起火烧烤店起火烧烤店起火烧烤店起火烧烤店起火烧烤店起火烤店起火烧烤店起火烧烤店起火烧烤店起火烧烤店起火烧烤店起火烧烤店起火烤店起火烧烤店起火烧烤店起火烧烤店起火烧烤店起火烧烤店起火烧烤店起火烤店起火烧烤店起火烧烤店起火烧烤店起火烧烤店起火烧烤店起火烧烤店起火烤店起火烧烤店起火烧烤店起火烧烤店起火烧烤店起火烧烤店起火烧烤店起火烤店起火烧烤店起火烧烤店起火烧烤店起火烧烤店起火烧烤店起火烧烤店起火。','startDay': 1254523654125,'endDay':1254523654125,'position':'华星路99号','areaId':3,'areaName':'多边形','image':image,'fileList':fileList},
            ],
            total: 3
        },
        '请求成功',
...
Mock.mock(/\/@test\/getEventDataList/, 'get', getEventDataList);
