...
Mock.mock(/\/@test\/getWaterLevelMacStatusAnalysisData/, 'get', getWaterStatusAnalysisData)
...
Mock.mock(/\/@test\/getManholeMacStatusAnalysisData/, 'get', getManholeStatusAnalysisData)
