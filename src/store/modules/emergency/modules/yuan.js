import {getYuAnDataList,
    getYuAnInfoById,
    addNewYuAn,
    deleteYuAn,
    getResourceDataList,
    getMapInfoByEventIdAndRTypeId} from '@/api/emergency/yuan.js'
...
export default {
    ...
    actions: {
        ...
        getMapInfoByEventIdAndRTypeId(state,data){
            return new Promise((resolve, reject) =>{
                getMapInfoByEventIdAndRTypeId(data)
                    .then(res => {
                        resolve(res)
                    })
                    .catch(err => {
