            ...
            <cg-container scroll>
                <div class="item" flex="dir:left main:justify" v-for="(item,index) in dataList" :key="index">
                    ...
                    <div flex="cross:center main:center">
                        ...
                        <a-icon v-show="!item.isStart" type="play-circle" theme="filled" @click="startPlay(index)"/>
                        <a-icon v-show="item.isStart" type="pause-circle" theme="filled" @click="pausePlay(index)"/>
                    </div>
                </div>
