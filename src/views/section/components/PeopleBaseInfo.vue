<template>
    <div class="base-panel" flex="dir:top">
        <div class="part">
            <h1>基本信息</h1>
            <div class="part-body" flex="cross:center main:justify">
                <div class="message">
                    <p><span class="title">真实姓名：</span><span>{{peopleInfo.realName}}</span></p>
                    <p><span class="title">编&emsp;&emsp;号：</span><span>{{peopleInfo.code}}</span></p>
                    <p><span class="title">手&ensp;机&ensp;号：</span><span>{{peopleInfo.phone}}</span></p>
                    <p><span class="title">职&emsp;&emsp;务：</span><span>{{peopleInfo.job}}</span></p>
                </div>
                <img :src="peopleInfo.phoneUrl">
            </div>
        </div>
        <div class="part trial">
            <h1>轨迹查询</h1>
                ...
                <div class="search-panel">
                    <div flex="fir:left cross:center">
                        ...
                        <a-radio-group name="sType" v-model="query.sType" style="width: 100%;">
                            ...
                            <a-radio value="2">越界</a-radio>
                            <a-radio value="3">超时停留</a-radio>
                        </a-radio-group>
                    </div>
