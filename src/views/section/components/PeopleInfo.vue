  ...
  <div class="tip-content">
    ...
    <div class="tip-body">
      ...
      <div class="data_panel" v-show="activeIndex === 0" flex="dir:left cross:center main:center">
        <div>
          <span>{{ todayData.num1 }}</span
          ><span>上报数</span>
        </div>
        <div>
          <span>{{ todayData.num2 }}</span
          ><span>核实数</span>
        </div>
        <div>
...
<!--        </div>-->
      ...
      <div class="data_panel" v-show="activeIndex === 1" flex="dir:left cross:center main:center">
        <div>
          <span>{{ historyData.num1 }}</span
          ><span>上报数</span>
        </div>
        <div>
          <span>{{ historyData.num2 }}</span
          ><span>核实数</span>
        </div>
        <div>
...
<!--        </div>-->
    ...
    <div class="info-body-operation" @click="lookPeopleInfo">
      查看详情
    </div>
