    ...
    <a-dropdown>
      <a-menu slot="overlay">
        ...
        <a-sub-menu>
          ...
          <a-menu-item @click="showTypePoints('救助管理站')">救助管理站</a-menu-item>
          <a-menu-item @click="showTypePoints('公园')">公园</a-menu-item>
          <a-menu-item @click="showTypePoints('广场')">广场</a-menu-item>
