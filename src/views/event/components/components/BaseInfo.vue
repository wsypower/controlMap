<template>
    <div class="base-info-panel">
        <a-row>
            <a-col :span="4">
                <label><i style="color:#d60000;">*</i>事件名称：</label>
            </a-col>
            <a-col :span="20">
                <a-input v-if="nowOptType" v-model="submitForm.name"  placeholder="请输入事件名称" style="width: 350px;"/>
                <span v-else>{{submitForm.name}}</span>
            </a-col>
        </a-row>
        <a-row>
            <a-col :span="4">
                <label><i style="color:#d60000;">*</i>事件类型：</label>
            </a-col>
            <a-col :span="20">
                <a-select v-if="nowOptType" v-model="submitForm.typeId" placeholder="请选择事件类型" style="width: 350px;">
        ...
        <a-row>
            ...
            <a-col :span="20">
                ...
                <span v-else>
                    ...
                    ~
                    {{new Date(submitForm.endDayTime)|date_format('YYYY-MM-DD HH:mm:ss')}}
                </span>
            </a-col>
        </a-row>
        <a-row>
            <a-col :span="4">
                <label><i style="color:#d60000;">*</i>事件描述：</label>
            </a-col>
            <a-col :span="20">
                <a-textarea v-if="nowOptType" v-model="submitForm.description"
        ...
        <a-row>
            <a-col :span="4">
                <label><i style="color:#d60000;">*</i>工作目标：</label>
            </a-col>
            <a-col :span="20">
                <a-textarea v-if="nowOptType" v-model="submitForm.jobGoal"
        ...
        <a-row>
            <a-col :span="4">
                <label><i style="color:#d60000;">*</i>组织领导及任务分工：</label>
            </a-col>
            <a-col :span="20">
                <a-textarea v-if="nowOptType" v-model="submitForm.jobAssignment"
        ...
        <a-row>
            <a-col :span="4">
                <label><i style="color:#d60000;">*</i>工作内容：</label>
            </a-col>
            <a-col :span="20">
                <a-textarea v-if="nowOptType" v-model="submitForm.jobContent"
        ...
        <a-row>
            <a-col :span="4">
                <label><i style="color:#d60000;">*</i>工作要求：</label>
            </a-col>
            <a-col :span="20">
                <a-textarea v-if="nowOptType" v-model="submitForm.jobRequirements"
...
export default {
  ...
  watch:{
    baseData: function(val){
      ...
      console.log('11111111111',this.submitForm);
      if(this.nowOptType){
        this.init();
      }
    },
