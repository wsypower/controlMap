<template>
  <div class="analysis-panel">
    <div class="panel-header" flex="dir:left cross:center">
      <span class="title">流量监测设备统计</span>
    </div>
...
export default {
    ...
    methods:{
        ...mapActions('watersupply/statistical', ['getFlowMacStatusAnalysisData']),
        //获取全部数据
        getChartData(){
            this.getFlowMacStatusAnalysisData({userId: userId}).then(res=>{
                console.log('getFlowMacStatusAnalysisData',res);
                res.forEach(item=>{
