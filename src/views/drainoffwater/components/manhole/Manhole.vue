  ...
  <div class="video-manage" flex="dir:top">
    <div class="search-panel">
      <div flex="fir:left cross:center">
        <label>所在区域：</label>
        <a-cascader :options="cityData" @change="onChange" changeOnSelect style="flex:1"/>
      </div>
      <div flex="fir:left cross:center" style="margin-top:10px">
        <label>井盖状态：</label>
        <!--<a-input placeholder="请选择" v-model="watchPlaceName" style="flex:1"/>-->
        <a-select v-model="status"  @change="handleChange" style="flex:1">
      ...
      <div flex="fir:left cross:center" style="margin:10px 0px;">
        <label>详细地址：</label>
        <a-input placeholder="输入详细地址" v-model="address" style="flex:1"/>
      </div>
      <div flex="fir:left cross:center" style="margin:10px 0px;">
        <label>井盖编号：</label>
        <a-input placeholder="输入井盖编号" v-model="code" style="flex:1"/>
      </div>
