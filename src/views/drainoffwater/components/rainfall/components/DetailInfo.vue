  ...
  <div class="tip-content">
    <div class="tip-header" flex="dir:left">
      <div class="info-body-left" flex="cross:center">
        ...
        <img  class="svg_icon_jiance" src="~@img/yuliang.png"/>
    ...
    <div class="tip-body">
      <div class="detail" flex="dir:left">
        ...
        <div class="detail-right" flex="dir:top main:justify">
          <div class="detail-right_item">当前小时降雨量：{{info.detailMessage.hourRainfall}}mm</div>
          <div class="detail-right_item">当前分钟降雨量：{{info.detailMessage.minuteRainfall}}mm</div>
          <div class="detail-right_item">连续降雨量：{{info.detailMessage.continuousRainfall}}mm</div>
        </div>
      </div>
