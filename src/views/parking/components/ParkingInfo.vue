  ...
  <div class="map-file-model">
    <div class="map-file-model-header" flex="cross:center main:justify">
      <div class="info-body-left" flex="cross:center">
        <cg-icon-svg name="parking" class="svg_icon_records"></cg-icon-svg>
        <span>停车场</span>
      </div>
    ...
    <div class="map-file-model-body">
      <div class="map-file-model-body-content">
        <div class="file-model-body-content active">
          <div class="file-message-item">
            ...
            <div class="file-message-item-list" flex>
              <div class="one-line">
                地&emsp;&emsp;址：
                <span :title="parkingData.address">{{ parkingData.address }}</span>
              </div>
            </div>
            <div class="file-message-item-list" flex>
              <div class="one-line">
                总泊位数：
                <span>{{ parkingData.totalCount }}</span>
              </div>
            </div>
            <div class="file-message-item-list" flex>
              <div class="one-line">
...
import { queryCurrentBerthCount } from '@/api/parking/manage'
export default {
  name: 'parkingInfo',
  props: {
    parkingData: {
  ...
  methods: {
    ...
    loadBerthCount() {
      queryCurrentBerthCount({
        parklotId: this.parkingData.id
      }).then(res => {
        // console.log(res);
