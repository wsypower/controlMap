...
export function getAllCarDataList(data) {
  ...
  return request({
    url: 'zcccar/getAllCarDataList?_t=' + new Date().getTime(),
    method: 'get',
    params: data
  })
}
...
export function getAllCarTreeData(data) {
  ...
  return request({
    url: 'zcccar/getAllCarTreeData?_t=' + new Date().getTime(),
    method: 'get',
    params: data
  })
}
...
export const getCarTrailDataList = data => {
  ...
  return request({
    url: `zcccar/getTrailDetailData?_t=`+ new Date().getTime(),
    method: 'post',
    data
  })
}
...
export const getAllGroupDataList = data => {
  ...
  return request({
    url: `zcccar/getAllGroupDataList?_t=` + new Date().getTime(),
    method: 'get',
    params: data
  })
}
...
export const getAllCarTypeDataList = data => {
  ...
  return request({
    url: `zcccar/getAllCarTypeDataList?_t=` + new Date().getTime(),
    method: 'get',
    params: data
  })
}
...
export const getCarViolateRulesDataList = data => {
  ...
  return request({
    url: `zcccar/getCarViolateRulesDataList`,
    method: 'post',
    data
  })
}
...
export const deleteCarViolateRules = data => {
  ...
  return request({
    url: `zcccar/deleteCarViolateRules`,
    method: 'post',
    data
  })
}
