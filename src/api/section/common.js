...
export function getAllPeopleDataList(data) {
  ...
  return request({
    url: 'people/getAllPeopleDataList?orgId=fa8a4910388311ebb43575e3c0ca945d&_t=' + new Date().getTime(),
    method: 'get',
    params: data
  })
}
...
export function getAllPeopleTreeData(data) {
  ...
  return request({
    url: 'people/getAllPeopleTreeData?orgId=fa8a4910388311ebb43575e3c0ca945d&_t=' + new Date().getTime(),
    method: 'get',
    params: data
  })
}
