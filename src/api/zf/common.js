...
export function getAllPeopleDataList(data) {
  ...
  return request({
    url: 'qxCollectionData/getAllPeopleDataList?orgId=b5dfc6e042dc11e814b4612fb490e44b&_t=' + new Date().getTime(),
    method: 'get',
    params: data
  })
}
...
export function getAllPeopleTreeData(data) {
  ...
  return request({
    url: 'qxCollectionData/getAllPeopleTreeData?orgId=b5dfc6e042dc11e814b4612fb490e44b&_t=' + new Date().getTime(),
    method: 'get',
    params: data
  })
}
